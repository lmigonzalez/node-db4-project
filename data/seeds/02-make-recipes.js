...
const ingredients = [
  { ingredients_name: "Broccoli", ingredients_unit: "lb" },
  { ingredients_name: "Pasto", ingredients_unit: "lb" },
  { ingredients_name: "Pasta", ingredients_unit: "lb" },
...
const steps = [
  ...
  { step_text: "Add pasto mixed with pasta", step_number: 3, recipe_id: 1 },
  // Lemon Chicken
